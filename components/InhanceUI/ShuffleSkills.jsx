...
const ShuffleHero = () => {
  return (
    <section className="w-full px-8 py-60 grid grid-cols-1 md:grid-cols-2 items-center gap-8 max-w-6xl mx-auto">
      <div>
...
const generateSquares = () => {
  ...
  return shuffle(squareData).map((sq) => (
    <motion.div
      ...
      className="w-full h-full relative bg-zinc-600 rounded-lg"
      // style={{
